...
?>
<?php 
$enable_video = kids_education_bell_get_option( 'single_page_video_enable' );
$enable_image = kids_education_bell_get_option( 'single_page_image_enable' );
$enable_header_image     = kids_education_bell_get_option( 'single_page_header_image_enable' ); ?>
