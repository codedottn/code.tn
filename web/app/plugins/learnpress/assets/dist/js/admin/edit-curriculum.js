...
const toggleSection = (e, target) => {
  ...
  if (elSection.classList.contains('open')) {
    ...
    _utils_js__WEBPACK_IMPORTED_MODULE_0__.lpShowHideEl(elSectionCollapse, 0);
  } else {
    elSection.classList.remove('close');
    elSection.classList.add('open');
    _utils_js__WEBPACK_IMPORTED_MODULE_0__.lpShowHideEl(elSectionCollapse, 1);
  }
};
...
// Element root ready.
_utils_js__WEBPACK_IMPORTED_MODULE_0__.lpOnElementReady('#admin-editor-lp_course', elAdminEditor => {
